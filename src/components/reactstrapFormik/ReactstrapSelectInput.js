  ...
  return (
    <>
      ...
      <div className={`custom-select-box ${props.formfloat == "true" && "form-floating"}`} ref={ref}>
        ...
        {!Array.isArray(selectedItems) && <Input id={props.inputprops.id} {...field} {...props} value={field.value ?? ""} placeholder="Search" className="form-control form-select" type="text" invalid={Boolean(touched[field.name] && errors[field.name])} disabled />}
